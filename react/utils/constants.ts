...
// Permission codes
export const ORGANIZATION_EDIT = 'buyer_organization_edit'
export const ORGANIZATION_VIEW = 'buyer_organization_view'

// License Manager B2B Organizations product (admin `granted` checks)
