...
## [Unreleased]
### Added
- Added notice bar reagarding breaking change to b2b suite apps. They will now require b2b read/write permissions from License Manager roles B2B Buyer Organizations
